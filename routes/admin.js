...
router.get("/assessment/:assessment_id/reports", adminPassport.authenticate("jwt", { session: false }), ReportController.assessmentAnalytics);
...
router.get("/assessment/reports/generate", adminPassport.authenticate("jwt", { session: false }), ReportController.generateUserResponseReport);
...
router.post("/question/:question_id/assessments/:assessment_id",adminPassport.authenticate("jwt", { session: false }), AssessmentController.getReplacementQuestion); 
