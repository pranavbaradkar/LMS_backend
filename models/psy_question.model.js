...
module.exports = (sequelize, DataTypes) => {
  var Model = sequelize.define('psy_questions', {
    ...
    score_type          : { type: DataTypes.INTEGER, allowNull: false },
    ...
    complexity_level    : { type: DataTypes.ENUM('P1', 'P2', 'P3', 'P4', 'P5'), allowNull: true, },
  ...
  Model.associate = (models)=> {
    Model.hasMany(models.psy_question_options, {foreignKey: 'psy_question_id', as:'options'});
  };
  return Model;
};